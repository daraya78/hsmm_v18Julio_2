    ...
    methods
        function self = hmm(ndim,nstates,emis_model2,in_model2,trans_model2)
            ...
            if exist('emis_model2','var')
                ...
                o=emis_model.normal_normal_gamma(self.ndim,self.nstates);
                self.emis_model=o;
        ...
        function [currentState, logP] = viterbihmm(self)
            [currentState, logP] = inference.viterbihmm(self)
        end
        function [data,seq,ndata,reseq,redur] = gen(self,ndata)
